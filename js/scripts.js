...
///////////////////////////////////////////////
	...
	t6D4.sticky_nav_enable1 = function () {
		$(".sidebar1 nav").sticky({
			topSpacing:24
			// getWidthFrom:".sidebar1",
			// className: ".sidebar1"
		});
	}
...
///////////////////////////////////////////////
	...
	/* 
	* If you enable smooth scroll you must use #IDs on an element for the links to work.  Jumping to regular link anchors won't.
	* 
	*/

	t6D4.smooth_scroll_enable1 = function () {
		// console.log('t6D4.smooth_scroll_enable1 is active');
		$("a").smoothScroll();
	}
...
////////////////////////////////////////////
	...
	t6D4.init = function () {
		t6D4.sticky_nav_enable1();
		t6D4.smooth_scroll_enable1();
	}
